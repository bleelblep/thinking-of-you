...
/**
 * Base service class for Glyph Toy implementations.
 * Handles Glyph Matrix Manager lifecycle and touch events.
 */
abstract class GlyphMatrixService(private val tag: String) : Service() {
                        ...
                        if (data.containsKey(KEY_DATA)) {
                            data.getString(KEY_DATA)?.let { value ->
                                when (value) {
                                    ...
                                    GlyphToy.EVENT_AOD -> onAlwaysOnDisplayEvent()
                                }
                            }
                        }
                    }
    ...
    open fun onAlwaysOnDisplayEvent() {}
