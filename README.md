...
The app uses Firebase REST API only — no SDK, no `google-services.json`. You'll need to update the database URL in the source to point at your own project. Paste your key gradle.properties
